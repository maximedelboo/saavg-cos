...
\citep{groningenSHRA}. Its model chain couples a seismic source model, a
...
$T_i\in\{0.01,0.1,\dots,0.85,1.0\}$\,s \citep{crowleyPinho}. Each per-period
...
\citep{fangOosterlee} of the cumulant characteristic function. The method never
...
Fourier--cosine series \citep{fangOosterlee}
\begin{equation}
